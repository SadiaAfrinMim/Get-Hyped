  ...
  return (
    <section className="py-32 px-6 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-4xl mx-auto">
        <h1
          ref={titleRef}
          className="text-5xl md:text-6xl font-black mb-8 text-center text-black opacity-0"
          style={{
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 text-center">
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <h4 className="text-2xl font-bold mb-4 text-black">Bel direct</h4>
            <a href="tel:+31615337496" className="text-2xl text-orange-500 hover:text-orange-600 transition-colors font-bold">
              +31 6 1533 7496
            </a>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <h4 className="text-2xl font-bold mb-4 text-black">Bezoek ons</h4>
